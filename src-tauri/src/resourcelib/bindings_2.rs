...
unsafe extern "C" {
	pub fn HM2_GetConverterForResource(p_ResourceType: *const ::std::os::raw::c_char) -> *mut ResourceConverter;
}
unsafe extern "C" {
	pub fn HM2_GetGeneratorForResource(p_ResourceType: *const ::std::os::raw::c_char) -> *mut ResourceGenerator;
}
unsafe extern "C" {
	pub fn HM2_GetSupportedResourceTypes() -> *mut ResourceTypesArray;
}
unsafe extern "C" {
	pub fn HM2_FreeSupportedResourceTypes(p_Array: *mut ResourceTypesArray);
}
unsafe extern "C" {
	pub fn HM2_IsResourceTypeSupported(p_ResourceType: *const ::std::os::raw::c_char) -> bool;
}
unsafe extern "C" {
	pub fn HM2_GameStructToJson(
...
unsafe extern "C" {
	pub fn HM2_FreeJsonString(p_JsonString: *mut JsonString);
}
unsafe extern "C" {
	pub fn HM2_GetPropertyName(p_PropertyId: u32) -> StringView;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]

...
unsafe extern "C" {
	pub fn HM2016_GetConverterForResource(p_ResourceType: *const ::std::os::raw::c_char) -> *mut ResourceConverter;
}
unsafe extern "C" {
	pub fn HM2016_GetGeneratorForResource(p_ResourceType: *const ::std::os::raw::c_char) -> *mut ResourceGenerator;
}
unsafe extern "C" {
	pub fn HM2016_GetSupportedResourceTypes() -> *mut ResourceTypesArray;
}
unsafe extern "C" {
	pub fn HM2016_FreeSupportedResourceTypes(p_Array: *mut ResourceTypesArray);
}
unsafe extern "C" {
	pub fn HM2016_IsResourceTypeSupported(p_ResourceType: *const ::std::os::raw::c_char) -> bool;
}
unsafe extern "C" {
	pub fn HM2016_GameStructToJson(
...
unsafe extern "C" {
	pub fn HM2016_JsonToGameStruct(
		p_StructureType: *const ::std::os::raw::c_char,
		p_JsonStr: *const ::std::os::raw::c_char,
		p_JsonStrLength: usize,
...
unsafe extern "C" {
	pub fn HM2016_FreeJsonString(p_JsonString: *mut JsonString);
}
unsafe extern "C" {
	pub fn HM2016_GetPropertyName(p_PropertyId: u32) -> StringView;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]

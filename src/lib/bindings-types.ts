...
export type ResourceOverviewData = { type: "Generic" } | { type: "Entity"; data: { blueprint_hash: string; blueprint_path_or_hint: string | null } } | { type: "GenericRL"; data: { json: string } } | { type: "Json"; data: { json: string } } | { type: "Ores"; data: { json: string } } | { type: "Image"; data: { image_path: string; dds_data: [string, string] | null } } | { type: "Audio"; data: { wav_path: string } } | { type: "Mesh"; data: { obj: string; bounding_box: [number, number, number, number, number, number] } } | { type: "MultiAudio"; data: { name: string; wav_paths: ([string, string])[] } } | { type: "Repository" } | { type: "Unlockables" } | { type: "HMLanguages"; data: { json: string } } | { type: "LocalisedLine"; data: { languages: ([string, string])[] } } | { type: "MaterialInstance"; data: { json: string } } | { type: "MaterialEntity"; data: { json: string } } | { type: "SoundDefinitions"; data: { json: string } }
...
export type SubEntityOperation = { SetParent: Ref } | { SetName: string } | { SetFactory: string } | { SetFactoryFlag: string | null } | { SetBlueprint: string } | { SetEditorOnly: boolean | null } | { AddProperty: [string, Property] } | { SetPropertyType: [string, string] } | { SetPropertyValue: SetPropertyValue } | { PatchArrayPropertyValue: [string, ArrayPatchOperation[]] } | { SetPropertyPostInit: [string, boolean] } | { RemovePropertyByName: string } | { AddPlatformSpecificProperty: [string, string, Property] } | { SetPlatformSpecificPropertyType: [string, string, string] } | { SetPlatformSpecificPropertyValue: SetPlatformSpecificPropertyValue } | { PatchPlatformSpecificArrayPropertyValue: [string, string, ArrayPatchOperation[]] } | { SetPlatformSpecificPropertyPostInit: [string, string, boolean] } | { RemovePlatformSpecificPropertyByName: [string, string] } | { RemovePlatformSpecificPropertiesForPlatform: string } | { AddEventConnection: [string, string, RefMaybeConstantValue] } | { RemoveEventConnection: [string, string, RefMaybeConstantValue] } | { RemoveAllEventConnectionsForTrigger: [string, string] } | { RemoveAllEventConnectionsForEvent: string } | { AddInputCopyConnection: [string, string, RefMaybeConstantValue] } | { RemoveInputCopyConnection: [string, string, RefMaybeConstantValue] } | { RemoveAllInputCopyConnectionsForTrigger: [string, string] } | { RemoveAllInputCopyConnectionsForInput: string } | { AddOutputCopyConnection: [string, string, RefMaybeConstantValue] } | { RemoveOutputCopyConnection: [string, string, RefMaybeConstantValue] } | { RemoveAllOutputCopyConnectionsForPropagate: [string, string] } | { RemoveAllOutputCopyConnectionsForOutput: string } | { AddPropertyAliasConnection: [string, PropertyAlias] } | { RemovePropertyAlias: string } | { RemoveConnectionForPropertyAlias: [string, PropertyAlias] } | { SetExposedEntity: [string, ExposedEntity] } | { RemoveExposedEntity: string } | { SetExposedInterface: [string, string] } | { RemoveExposedInterface: string } | { AddSubset: [string, string] } | { RemoveSubset: [string, string] } | { RemoveAllSubsetsFor: string }
